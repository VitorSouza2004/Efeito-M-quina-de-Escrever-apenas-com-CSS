O css foi feito para mobile, porém caso deseje também para desktop então diminua o valor do keyframe "escrever" em to no width e aplique media queries para cada tamanho de tela que desejar.
